...
is fitted, then a GAM model with no transformation on square feet and rent but with 
degree 3 thin-plate smooth on square feet is tried. Finally, a log log GAM model with 
degree 3 thin-plate smooth on log(sqft) is tested as well. Finally, the models 
...
ggplot(gam.confint.beds, aes(x = Term, y = exp(Estimate), color = Term)) + scale_y_continuous(limits = c(1, 1.4), breaks = seq(1, 1.4, 0.05)) +
  ...
  ggtitle("Multiplicative Effect of Bedroms") 
```
